...
private:
	...
	// Enables / Disables undo and redo buttons
	void UpdateUndoRedoButtons();

	// Enables / Disables select menu option
...
private:
	...
	// Menus
	class wxMenu* mFileMenu = nullptr;
	class wxMenu* mEditMenu = nullptr;
	class wxMenu* mColorMenu = nullptr;
	// Toolbar
	class wxToolBar* mToolbar = nullptr;
	// Panel for drawing
	class PaintDrawPanel* mPanel = nullptr;

	EventID mCurrentTool = ID_Selector;
};
